...
repo() {
  link="https://raw.githubusercontent.com/drowkid01/VPS-MX-8.5-Sin-Key/main/Repositorios/$1.list"
  case $1 in
...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/drowkid01/VPS-MX-8.5-Sin-Key/main/Instalador/Install-Sin-Key.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
  title -verd "Actualización de sistema"
...
install_start() {
  msg -bar
  echo -e "	╻ ╻┏━┓┏━┓   ┏┳┓╻ ╻
	┃┏┛┣━┛┗━┓╺━╸┃┃┃┏╋┛	\033[0m\033[1;32m＠\033[1;34mｄ\033[1;35mｒ\033[1;31mｏ\033[1;36mｗ\033[1;35mｋ\033[1;34mｉ\033[1;31mｄ\033[1;36m０\033[1;32m１\033[0m
	┗┛ ╹  ┗━┛   ╹ ╹╹ ╹
"
  msgi -bar
  echo -e "\e[1;97m           \e[5m\033[1;100m   Actualización de sistema   \033[1;37m"
  msg -bar
...
install_continue() {
  ...
  os_system
  msg -bar
  echo -e "      \e[5m\033[1;100m   INSTALANDO RECURSOS EXTRAS  \033[1;37m"
  msg -bar
...
wget https://raw.githubusercontent.com/drowkid01/VPS-MX-8.5-Sin-Key/main/code/speedtest_v1.tar >/dev/null 2>&1
...
[[ $(find /etc/VPS-MX/controlador -name nombre.log | grep -w "nombre.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/nombre.log https://github.com/drowkid01/VPS-MX-8.5-Sin-Key/blob/main/Archivos%20Utilitarios/nombre.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name IDT.log | grep -w "IDT.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/IDT.log https://github.com/drowkid01/VPS-MX-8.5-Sin-Key/blob/main/Archivos%20Utilitarios/IDT.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name tiemlim.log | grep -w "tiemlim.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/tiemlim.log https://github.com/drowkid01/VPS-MX-8.5-Sin-Key/blob/main/Archivos%20Utilitarios/tiemlim.log &>/dev/null
touch /usr/share/lognull &>/dev/null
wget https://raw.githubusercontent.com/drowkid01/VPS-MX-8.5-Sin-Key/main/SR/SPR -O /usr/bin/SPR &>/dev/null &>/dev/null
...
SOPORTE &>/dev/null
wget -O /bin/rebootnb https://raw.githubusercontent.com/drowkid01/VPS-MX-8.5-Sin-Key/main/SCRIPT-8.4/Utilidad/rebootnb &>/dev/null
chmod +x /bin/rebootnb
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/drowkid01/VPS-MX-8.5-Sin-Key/main/SCRIPT-8.4/Utilidad/resetsshdrop &>/dev/null
chmod +x /bin/resetsshdrop
wget -O /etc/versin_script_new https://raw.githubusercontent.com/drowkid01/VPS-MX-8.5-Sin-Key/main/SCRIPT-8.4/Vercion &>/dev/null
grep -v "^PasswordAuthentication" /etc/ssh/sshd_config >/tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
echo "PasswordAuthentication yes" >>/etc/ssh/sshd_config
v1=$(curl -sSL "https://raw.githubusercontent.com/drowkid01/VPS-MX-8.5-Sin-Key/main/SCRIPT-8.4/Vercion") 
echo "$v1" > /etc/versin_script 
msg -bar2
...
echo "exit 0" >>/etc/rc.local
  ...
  clear && clear
  msg -bar
  echo -e "⚡| M O D  by: \033[0m\033[1;32m＠\033[1;34mｄ\033[1;35mｒ\033[1;31mｏ\033[1;36mｗ\033[1;35mｋ\033[1;34mｉ\033[1;31mｄ\033[1;36m０\033[1;32m１\033[0m |⚡"
